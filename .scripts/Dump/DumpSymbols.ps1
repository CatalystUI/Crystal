...
# --- Run Roslynator ---
roslynator list-symbols ./CatalystUI/CatalystUI.sln -o DumpSymbols.txt --documentation --group-by-assembly --ignored-parts containing-namespace containing-namespace-in-type-hierarchy --empty-line-between-members