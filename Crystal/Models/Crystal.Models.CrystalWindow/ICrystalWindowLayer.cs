...
using Crystal.Models.CrystalWindow.Windowing;

namespace Crystal.Models.CrystalWindow {
    
    /// <summary>
    /// Represents the window layer API for windows within the Crystal framework.
    /// </summary>
    public interface ICrystalWindowLayer : IWindowLayer<ICrystalWindowDomain> {
