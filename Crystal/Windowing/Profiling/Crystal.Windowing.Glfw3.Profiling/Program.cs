...
namespace Catalyst.Profiling {
    ...
    /// <summary>
    /// A basic program used for general profiling of the Crystal Glfw3 windowing library.
    /// </summary>
    /// <remarks>
    /// <para>
    /// This executable project references all Glfw3-related libraries. It references
    /// a class called <c>Profile</c>, and fires a method with the signature
    /// <c>static void Run()</c>.
    /// </para>
    /// <para>
    /// <b>To use this project</b>, copy the <c>Profile.template.cs</c>
    ...
    /// testing project to the repository. This project only commits
